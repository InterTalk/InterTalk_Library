...
package com.intertalk.ui.widget.pullRefreshLayout;
...
import com.intertalk.ui.BuildConfig;
import com.intertalk.ui.R;
import com.intertalk.ui.nestedScroll.QMUIContinuousNestedScrollLayout;
import com.intertalk.ui.util.QMUIDisplayHelper;
import com.intertalk.ui.util.QMUIResHelper;
import com.intertalk.ui.widget.section.QMUIStickySectionLayout;
 ...
 * <li>可在 xml 中使用 {@link com.intertalk.ui.R.styleable#QMUIPullRefreshLayout} 这些属性或在 Java 设置对应的属性决定子View的开始位置、触发刷新的位置等值</li>
 * </ul>
 *
 * @author cginechen
 * @date 2016-12-11
